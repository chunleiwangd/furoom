...
function header(title){
	...
	var divtitle = $('<div style="margin-top:5px; padding: 10px 10px 0px 10px;"></div>');
//	divtitle.append('<font style="font-size:30px; font-weight:bold; margin-left:15px; color:orange; font-family:SimHei" class="text-muted">政采贷</font><font>&nbsp;&nbsp;信用创造价值</font>');
	divtitle.append('<img src="img/logo.png" style="max-width:95%; margin-top:5px;"></img>');
	if(title=='login' || title=='register'){
		if(usertype=='lender')
		{
			window.location.href="myaccount.html?version=20150709";
		}else if(usertype=='borrower'){
			window.location.href="baccount.html?version=20150709";
		}
		else
			{
		...
		if(usertype=='lender'){
			...
			divusercontent.html(greet()+"企业用户"+user.loginId+'&nbsp;&nbsp;|&nbsp;&nbsp;<a href="quit.html?version=20150709" style="color:white;">退出</a>');
		}else{
			divusercontent.html('<a href="login.html?version=20150709" style="color:white;">登录</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="register.html?version=20150709" style="color:white;">注册</a>');
		}
	}
	else{
	if(usertype=='lender'){
		divusercontent.html(greet()+user.loginId+'&nbsp;&nbsp;<a style="color:white;" href="myaccountdetail.html?fid=mycenter&sid=letter-unread-mycenter&version=20150709" id="inner_letter" target="_blank"><span class="glyphicon glyphicon-envelope" style="margin-left:10px; color=red"></span>&nbsp;'+lettercount+'</a>'+'&nbsp;&nbsp;|&nbsp;&nbsp;<a href="quit.html" style="color:white;">退出</a>');
	}else if(usertype=='borrower'){
		divusercontent.html(greet()+"企业用户"+user.loginId+'&nbsp;&nbsp;|&nbsp;&nbsp;<a href="quit.html?version=20150709" style="color:white;">退出</a>');
	}else{
		divusercontent.html('<a href="login.html?version=20150709" style="color:white;">登录</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="register.html?version=20150709" style="color:white;">注册</a>');
	...
	divusercontent.append('<div style="clear:both;"></div>');
...
//		}
	navulstr += '<li id="activity"><a href="activity.html?version=20150709">活动中心</a></li>';
	...
	navulstr += '<li><a href="helpcenter.html?type=0&version=20150709" target="_blank">新手帮助</a></li>';
	navulstr += '<li><a href="helpcenter.html?type=1&version=20150709" target="_blank">常见问题</a></li>';
	navulstr += '<li><a href="helpcenter.html?type=3&version=20150709" target="_blank">投资融资</a></li>';
	navulstr += '<li class="divider"></li>';
	navulstr += '<li><a href="noticecenter.html?type=0&version=20150709" target="_blank">平台公告</a></li>';
	navulstr += '<li><a href="newscenter.html?type=-1&version=20150709" target="_blank">新闻资讯</a></li>';
	navulstr += '</ul>';
	navulstr += '</li>';
	navulstr += '</ul>';
