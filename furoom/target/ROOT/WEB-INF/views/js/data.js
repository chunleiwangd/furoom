...
var createNavLevel2 = function(nav){
	...
	//	li4.append(ul2);
		...
		var li3 = $('<li role="presentation"><a href="javascript:void(0)" data-sk="submit-subscribe-toafford">预约成功</a></li>');
		...
		var li4 = $('<li role="presentation"><a href="javascript:void(0)" data-sk="purchasebacktoaudit">出售处理中</a></li>');
